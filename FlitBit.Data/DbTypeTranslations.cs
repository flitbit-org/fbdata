    ...
    internal static class DbTypeTranslations
    {
        static readonly DbTypeTranslation[] DbTypeMap =
        {
            ...
            new DbTypeTranslation(DbType.Binary, (int)DbType.Binary, typeof(byte[]), true, "BINARY",
                DbTypeLengthRequirements.Length)
            ,
            new DbTypeTranslation(DbType.Byte, (int)DbType.Byte, typeof(byte), true, "TINYINT",
                DbTypeLengthRequirements.None)
            ,
            new DbTypeTranslation(DbType.Boolean, (int)DbType.Boolean, typeof(bool), true, "BIT",
                DbTypeLengthRequirements.None)
            ,
            new DbTypeTranslation(DbType.Currency, (int)DbType.Currency, typeof(decimal), false, "MONEY",
                DbTypeLengthRequirements.Length)
            ,
            new DbTypeTranslation(DbType.Date, (int)DbType.Date, typeof(DateTime), false, "DATE",
                DbTypeLengthRequirements.None)
            ,
            ...
            new DbTypeTranslation(DbType.Int16, (int)DbType.Int16, typeof(short), true, "SMALLINT",
                DbTypeLengthRequirements.None)
            ,
            new DbTypeTranslation(DbType.Int32, (int)DbType.Int32, typeof(int), true, "INT",
                DbTypeLengthRequirements.None)
            ,
            new DbTypeTranslation(DbType.Int64, (int)DbType.Int64, typeof(long), true, "BIGINT",
                DbTypeLengthRequirements.None)
            ,
            new DbTypeTranslation(DbType.Object, (int)DbType.Object, typeof(long), true, "OBJECT",
                DbTypeLengthRequirements.None)
            ,
            new DbTypeTranslation(DbType.SByte, (int)DbType.SByte, typeof(byte), true, "TINYINT",
                DbTypeLengthRequirements.None)
            ,
            ...
            new DbTypeTranslation(DbType.String, (int)DbType.String, typeof(string), true, "NVARCHAR",
                DbTypeLengthRequirements.Length)
            ,
            new DbTypeTranslation(DbType.Time, (int)DbType.Time, typeof(DateTime), false, "TIME",
                DbTypeLengthRequirements.None)
            ,
            new DbTypeTranslation(DbType.UInt16, (int)DbType.UInt16, typeof(ushort), true, "INT",
                DbTypeLengthRequirements.None)
            ,
            ...
            ,
            new DbTypeTranslation(DbType.StringFixedLength, (int)DbType.StringFixedLength, typeof(string), false,
                "NCHAR",
                DbTypeLengthRequirements.Length)
            ,
            ...
            new DbTypeTranslation(DbType.DateTime2, (int)DbType.DateTime2, typeof(DateTime), false, "DATETIME2",
                DbTypeLengthRequirements.Length)
            ,
            new DbTypeTranslation(DbType.DateTimeOffset, (int)DbType.DateTimeOffset, typeof(DateTime), false,
                "DATETIMEOFFSET",
                DbTypeLengthRequirements.None)
        };
        ...
        public static DbTypeTranslation TranslateRuntimeType(Type type)
        {
            ...
            if (result == null)
            {
                ...
                if (__runtimeTypeMappings.IsValueCreated)
                {
