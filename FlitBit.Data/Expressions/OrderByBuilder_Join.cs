...
namespace FlitBit.Data.Expressions
{
  ...
  public class OrderByBuilder<TDataModel, TJoin> : OrderByBuilder
  {
    ...
    public OrderByBuilder<TDataModel, TJoin> OrderBy(Expression<Func<TDataModel, TJoin, object>> expression, SortOrderKind kind)
    {
      Contract.Requires<ArgumentNullException>(expression != null);
    ...
    public OrderByBuilder<TDataModel, TJoin> ThenBy(Expression<Func<TDataModel, TJoin, object>> expression, SortOrderKind kind)
    {
      Contract.Requires<ArgumentNullException>(expression != null);
