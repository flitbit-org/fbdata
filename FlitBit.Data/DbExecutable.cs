...
{
    public class DbExecutable<THelper, TConnection, TCommand, TDbDataReader, TDataBinder>
        ...
        where TDataBinder : class, IDataParameterBinder, new()
    {
        ...
        readonly IDbExecutable _definition;
        bool _ourConnection;
        ...
        protected TConnection MakeDbConnection()
        {
            ...
            if (_connection == null)
            {
                ...
                if (context != null)
                {
                    if ((_behavior & CommandBehaviors.ShareConnectionIfAvailable)
                        == CommandBehaviors.ShareConnectionIfAvailable)
                    {
        ...
        public IDbExecutable CreateOnConnection(DbConnection connection)
        {
            ...
            return new DbExecutable<THelper, TConnection, TCommand, TDbDataReader, TDataBinder>(
