...
namespace FlitBit.Data
{
    ...
    public interface IDataParameterBinder
    {
        ...
        int GetInt32(DbCommand cmd, string name);
    }

    namespace CodeContracts
    {
        /// <summary>
        ///     CodeContracts Class for IDataParameterBinder
        /// </summary>
        ...
        internal abstract class ContractsForIDataParameterBinder : IDataParameterBinder
        {
            public void GetParameterValueAs<T>(string name, out T value)
            {
                ...
                Contract.Requires<ArgumentOutOfRangeException>(IndexOfParameter(name) >= 0,
                    Resources.Chk_ParameterNotDefined);
            ...
            {
                Contract.Requires<ArgumentNullException>(name != null);
                Contract.Requires<InvalidOperationException>(IndexOfParameter(name) < 0,
                    Resources.Chk_ParameterObstructed);
