...
namespace FlitBit.Data.SqlServer
{
    internal static class OneClassOneTableEmitter
    {
        ...
        internal static Type ReadByIdCommand<TDataModel, TImpl, TIdentityKey>(IMapping<TDataModel> mapping,
            DynamicSql sql)
            where TImpl : class, IDataModel, TDataModel, new()
        {
            Contract.Ensures(Contract.Result<Type>() != null);
            ...
            {
                var type = module.Builder.GetType(typeName, false, false) ??
                           EmitImplementation<TDataModel, TImpl>.BuildReadByIdCommand<TIdentityKey>(module, typeName,
                               mapping,
                               sql);
                return type;
            }
        ...
        internal static Type DeleteCommand<TDataModel, TImpl, TIdentityKey>(IMapping<TDataModel> mapping,
            DynamicSql deleteStatement)
            where TImpl : class, IDataModel, TDataModel, new()
        {
            Contract.Ensures(Contract.Result<Type>() != null);
            ...
            {
                var type = module.Builder.GetType(typeName, false, false) ??
                           EmitImplementation<TDataModel, TImpl>.BuildDeleteCommand<TIdentityKey>(module, typeName,
                               mapping,
                               deleteStatement);
                return type;
            }
        ...
        internal static Type MakeQueryCommand<TDataModel, TImpl, TParam>(IMapping<TDataModel> mapping, string queryKey,
            ...
            where TImpl : class, IDataModel, TDataModel, new()
        {
            ...
            {
                var type = module.Builder.GetType(typeName, false, false) ??
                           EmitImplementation<TDataModel, TImpl>.BuildQueryCommand(module, typeName, mapping, sql,
                               typeof(SqlDataModelQueryCommand<TDataModel, TImpl, TParam>));
                return type;
            }
        }
        ...
        internal static Type MakeQueryCommand<TDataModel, TImpl>(IMapping<TDataModel> mapping, string queryKey,
            DataModelSqlExpression<TDataModel> sql)
            where TImpl : class, IDataModel, TDataModel, new()
        {
            Contract.Requires<ArgumentNullException>(sql != null);
            ...
            switch (parms.Count)
            {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    cmdType = typeof(SqlDataModelQueryCommand<,,,,,,,>).MakeGenericType(typeof(TDataModel),
                        typeof(TImpl),
                        parms[0].Type,
                        parms[1].Type,
                        parms[2].Type,
                ...
                case 10:
                    ...
                    break;
                default:
                    throw new NotImplementedException("Emitter cannot construct commands with " + parms.Count
                                                      + " parameters.");
            }
        ...
        {
            public static Type BuildUpdateCommand(EmittedModule module, string typeName, IMapping<TDataModel> mapping,
                DataModelSqlExpression<TDataModel> sql, Type baseType)
            {
                ...
                ctor.ContributeInstructions((m, il) =>
                {
                    ...
                    il.LoadArg_1();
                    il.LoadArg_2();
                    il.Call(baseType.GetConstructor(BindingFlags.Instance | BindingFlags.NonPublic, null, new[]
                    {
                        typeof(DynamicSql),
                        typeof(int[])
                    }, null));
                ...
                ImplementBindQueryCommand(builder, baseType, mapping, sql);

                builder.Compile();
                return builder.Ref.Target;
            }

            public static void ImplementBindQueryCommand(EmittedClass builder, Type baseType,
                IMapping<TDataModel> mapping,
                DataModelSqlExpression<TDataModel> sql)
            {
                var method =
                    builder.DefineOverrideMethod(baseType.GetMethod("BindCommand",
        ...
        static class EmitImplementation<TDataModel, TImpl>
            where TImpl : class, IDataModel, TDataModel, new()
        {
            internal static Type BuildCreateCommand(EmittedModule module, string typeName, IMapping<TDataModel> mapping,
                DynamicSql sql)
            {
                Contract.Requires<ArgumentNullException>(module != null);
                Contract.Requires<ArgumentNullException>(typeName != null);
            ...
            static void ImplementCreateBindCommand(EmittedClass builder, Type baseType, IMapping<TDataModel> mapping,
                DynamicSql sql)
            {
                var method =
                    builder.DefineOverrideMethod(baseType.GetMethod("BindCommand",
                ...
                method.ContributeInstructions((m, il) =>
                {
                    ...
                    {
                        if (column.IsTimestampOnInsert
                            || column.IsTimestampOnUpdate)
                        {
                    ...
                    il.LoadValue(",\r\n\t");
                    il.LoadLocal(columnList);
                    il.Call<String>("Join", BindingFlags.Static | BindingFlags.Public, typeof(string),
            ...
            internal static Type BuildUpdateCommand(EmittedModule module, string typeName, IMapping<TDataModel> mapping,
                DynamicSql sql)
            {
                Contract.Requires<ArgumentNullException>(module != null);
                Contract.Requires<ArgumentNullException>(typeName != null);
            ...
            static void ImplementUpdateBindCommand(EmittedClass builder, Type baseType, IMapping<TDataModel> mapping,
                DynamicSql sql)
            {
                var method =
                    builder.DefineOverrideMethod(baseType.GetMethod("BindCommand",
                ...
                method.ContributeInstructions((m, il) =>
                {
                    ...
                    foreach (var column in mapping.Columns)
                    {
                        ...
                        {
                            il.LoadLocal(columnList);
                            il.LoadValue(String.Concat(mapping.QuoteObjectName(column.TargetName), " = ",
            ...
            internal static Type BuildDeleteCommand<TIdentityKey>(EmittedModule module, string typeName,
            ...
            internal static Type BuildReadByIdCommand<TIdentityKey>(EmittedModule module, string typeName,
                IMapping<TDataModel> mapping, DynamicSql sql)
            {
                Contract.Requires<ArgumentNullException>(module != null);
                Contract.Requires<ArgumentNullException>(typeName != null);
            ...
            public static Type BuildRepository<TIdentityKey>(EmittedModule module, string typeName,
                IMapping<TDataModel> mapping)
            {
                Contract.Requires<ArgumentNullException>(module != null);
                Contract.Requires<ArgumentNullException>(typeName != null);
            ...
            static void ImplementGetIdentity<TIdentityKey>(EmittedClass builder, Type baseType,
                IMapping<TDataModel> mapping)
            {
                var method = builder
            ...
            internal static Type BuildQueryCommand(EmittedModule module, string typeName, IMapping<TDataModel> mapping,
                DataModelSqlExpression<TDataModel> sql, Type baseType)
            {
                Contract.Requires<ArgumentNullException>(module != null);
                Contract.Requires<ArgumentNullException>(typeName != null);
