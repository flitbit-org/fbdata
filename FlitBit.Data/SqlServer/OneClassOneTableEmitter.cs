...
namespace FlitBit.Data.SqlServer
{
  internal static class OneClassOneTableEmitter
  {
      ...
      where TImpl : class, IDataModel, TDataModel, new()
    {
      ...
      {
        var type = module.Builder.GetType(typeName, false, false) ??
                   EmitImplementation<TDataModel, TImpl>.BuildDeleteCommand<TIdentityKey>(module, typeName, mapping,
                     deleteStatement);
        return type;
      }
    }
      ...
      where TImpl : class, IDataModel, TDataModel, new()
    {
      ...
      {
        var type = module.Builder.GetType(typeName, false, false) ??
                   EmitImplementation<TDataModel, TImpl>.BuildQueryCommand(module, typeName, mapping, sql, cmdType);
        return type;
      }
    }
    ...
    static class EmitImplementation<TDataModel>
    {
      ...
      public static void ImplementBindQueryCommand(EmittedClass builder, Type baseType, IMapping<TDataModel> mapping,
        DataModelSqlExpression<TDataModel> sql)
      {
        var method =
      ...
      where TImpl : class, IDataModel, TDataModel, new()
    {
      ...
      static void ImplementGetIdentity<TIdentityKey>(EmittedClass builder, Type baseType, IMapping<TDataModel> mapping)
      {
        var method = builder
