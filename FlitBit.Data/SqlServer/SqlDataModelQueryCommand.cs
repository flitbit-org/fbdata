...
namespace FlitBit.Data.SqlServer
{
    ...
    where TImpl : IDataModel, TDataModel, new()
  {
      ...
      TParam param, TParam1 param1)
    {
      ...
      if (limited)
      {
        return
          new DataModelQueryResult<TDataModel>(
            new QueryBehavior(behavior.Behaviors, behavior.PageSize, page, totalRows),
            res);
      }
      return new DataModelQueryResult<TDataModel>(new QueryBehavior(behavior.Behaviors), res);
    }
  ...
  public abstract class SqlDataModelQueryCommand<TDataModel, TImpl, TParam, TParam1, TParam2, TParam3> :
    SqlDataModelCommand,
  ...
  public abstract class SqlDataModelQueryCommand<TDataModel, TImpl, TParam, TParam1, TParam2, TParam3, TParam4> :
    SqlDataModelCommand,
  ...
  public abstract class SqlDataModelQueryCommand<TDataModel, TImpl, TParam, TParam1, TParam2, TParam3, TParam4, TParam5> :
    SqlDataModelCommand,
  ...
  public abstract class SqlDataModelQueryCommand<TDataModel, TImpl, TParam, TParam1, TParam2, TParam3, TParam4, TParam5,
                                                 TParam6> : SqlDataModelCommand,
                                                   IDataModelQueryCommand
                                                     <TDataModel, SqlConnection, TParam, TParam1, TParam2, TParam3,
  ...
  public abstract class SqlDataModelQueryCommand<TDataModel, TImpl, TParam, TParam1, TParam2, TParam3, TParam4, TParam5,
                                                 TParam6, TParam7> : SqlDataModelCommand,
                                                   IDataModelQueryCommand
                                                     <TDataModel, SqlConnection, TParam, TParam1, TParam2, TParam3,
  ...
  public abstract class SqlDataModelQueryCommand<TDataModel, TImpl, TParam, TParam1, TParam2, TParam3, TParam4, TParam5,
                                                 TParam6, TParam7, TParam8> : SqlDataModelCommand,
                                                   IDataModelQueryCommand
                                                     <TDataModel, SqlConnection, TParam, TParam1, TParam2, TParam3,
  ...
  public abstract class SqlDataModelQueryCommand<TDataModel, TImpl, TParam, TParam1, TParam2, TParam3, TParam4, TParam5,
                                                 TParam6, TParam7, TParam8, TParam9> : SqlDataModelCommand,
                                                   IDataModelQueryCommand
                                                     <TDataModel, SqlConnection, TParam, TParam1, TParam2, TParam3,
