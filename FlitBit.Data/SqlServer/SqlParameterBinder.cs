...
namespace FlitBit.Data.SqlServer
{
    public class SqlParameterBinder : DataParameterBinder
    {
        ...
        protected override IDataParameter MakeParameter(DbCommand command, string name, DbType dbType,
            int specializedDbType,
            int length, ParameterDirection direction)
        {
            var scmd = (SqlCommand)command;
            var parm = scmd.Parameters.Add(name, (SqlDbType)specializedDbType, length);
        ...
        {
            var scmd = (SqlCommand)command;
            var parm = scmd.Parameters.Add(name, (SqlDbType)specializedDbType, size);
            parm.Scale = scale;
            parm.Direction = direction;
            return parm;
        }
        ...
        {
            var scmd = (SqlCommand)command;
            var parm = scmd.Parameters.Add(name, (SqlDbType)specializedDbType);
            parm.Direction = direction;
            return parm;
        }
        ...
        protected override void PerformSetParameterValue(ParameterBinding[] parameters, int p, string name,
            decimal value)
        {
        ...
        {
            var bindings = new List<ParameterBinding>(parameters.Count());
