...
namespace FlitBit.Data.SqlServer
{
	...
	public class DynamicSql
	{
		...
		/// <summary>
		/// For identity based operations/statements, indicates the name of the identity parameter that must be bound for the statement.
		/// </summary>
		public string BindIdentityParameter { get; set; }

		/// <summary>
		/// For paging and limited results, indicated the name of the limit parameter that must be bound for the statement. Limit serves as the page size parameter when paging.
		/// </summary>
