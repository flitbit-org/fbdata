...
namespace FlitBit.Data.SqlServer
{
    ...
    public abstract class SingleUpdateQueryCommand<TDataModel, TImpl> :
        ...
        public TDataModel ExecuteSingle(IDbContext cx, SqlConnection cn, TDataModel param)
        {
            ...
            if (impl == null)
            {
                throw new InvalidOperationException(
                    "You must transform the instance to the mapped concrete type before saving.");
            }

            var dirty = impl.GetDirtyFlags();
