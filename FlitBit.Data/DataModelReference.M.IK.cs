...
{
	[Serializable]
	public sealed class DataModelReference<M, IK> : IDataModelReference<M, IK>, IDataModelReferent<M, IK>, IEquatable<DataModelReference<M, IK>>
	{
		...
		public DataModelReference(IK id)
		{
			_id = id;
		}
		...
		public object Clone()
		{
			return (DataModelReference<M, IK>)this.MemberwiseClone();
		}
