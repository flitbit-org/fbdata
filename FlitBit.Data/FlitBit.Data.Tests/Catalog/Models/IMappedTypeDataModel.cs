...
namespace FlitBit.Data.Tests.Catalog.Models
{
	...
	{
		// Fields
		private static readonly string[] __fieldMap = new string[] { "Catalog", "DateCreated", "DateUpdated", "ID", "LatestVersion", "MappedBaseType", "MappedTable", "OriginalVersion", "ReadObjectName", "RegisteredSubtypes", "RuntimeType", "Schema", "Strategy" };
		/* private scope */
