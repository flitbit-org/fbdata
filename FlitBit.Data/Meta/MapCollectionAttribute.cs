...
namespace FlitBit.Data.Meta
{
  ...
  public sealed class MapCollectionAttribute : Attribute
  {
    ...
    /// <param name="referencedPropertyNames"></param>
    /// <param name="localPropertyNames"></param>
    public MapCollectionAttribute(ReferenceBehaviors behaviors, string referencedPropertyNames,
      string localPropertyNames)
    ...
    public MapCollectionAttribute(ReferenceBehaviors behaviors, string referencedPropertyNames,
      string localPropertyNames, Type joinType, string joinPropertyNames)
    {
      Behaviors = behaviors;
    ...
    /// <summary>
    ///   The collection's join type. A join type is the type that joins the target type with the reference type, such as in a
    ///   many-to-many join it is the type that holds the references going in both directions.
    /// </summary>
