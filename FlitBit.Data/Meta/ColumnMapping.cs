...
namespace FlitBit.Data.Meta
{
    public class ColumnMapping
    {
        ...
        public MappedDbTypeEmitter Emitter
        {
            ...
            {
                if (_emitter == null
                    || _emitter.Item1 != Mapping.Revision)
                {
                    _emitter = Tuple.Create(Mapping.Revision, Mapping.GetColumnEmitter(this));
                }
        ...
        {
            get { return String.Concat(Mapping.DbObjectReference, '.', Mapping.QuoteObjectName(TargetName)); }
        }
        ...
        /// </summary>
        public Type RuntimeType { get { return Member.GetTypeOfValue(); } }
        ...
        public Type UnderlyingType { get { return Emitter.UnderlyingType; } }
    }
}