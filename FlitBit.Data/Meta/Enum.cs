...
namespace FlitBit.Data.Meta
{
  ...
  public enum ReferenceBehaviors
  {
    ...
    /// <summary>
    ///   Indicates the foreign key should be defined to update cascade. Applise to reference properties; no affect on
    ///   reference collections.
    /// </summary>
    OnUpdateCascade = 1 << 2,

    /// <summary>
    ///   Indicates the foreign key should be defined to delete cascade. Applise to reference properties; no affect on
    ///   reference collections.
    /// </summary>
    OnDeleteCascade = 1 << 3,

    /// <summary>
    ///   Indicates the foreign key should be defined to set null on delete. Applise to reference properties; no affect on
    ///   reference collections.
    /// </summary>
    OnDeleteSetNull = 1 << 4,

    /// <summary>
    ///   Indicates the foreign key should be defined to set default on delete. Applise to reference properties; no affect on
    ///   reference collections.
    /// </summary>
