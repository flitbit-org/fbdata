...
namespace FlitBit.Data.Meta.DDL
{
    ...
    {
        readonly Dictionary<string, DDLNode> _children = new Dictionary<string, DDLNode>();
        ...
        public DDLTable DefineTable(string name, DDLBehaviors behaviors)
        {
            ...
            {
                throw new InvalidOperationException(String.Concat("Table `", name, "` is obstructed another node: ",
                    n.Kind, "."));
            }
            return (DDLTable)n;
        }
        ...
        public DDLCatalog UseCatalog(string name, DDLBehaviors behaviors)
        {
            ...
            {
                throw new InvalidOperationException(String.Concat("Catalog `", name, "` is obstructed another node: ",
                    n.Kind,
                    "."));
            }
            return (DDLCatalog)n;
        ...
        public DDLSchema UseSchema(string name, DDLBehaviors behaviors)
        {
            ...
            {
                throw new InvalidOperationException(String.Concat("Schema `", name, "` is obstructed another node: ",
                    n.Kind,
                    "."));
            }
            return (DDLSchema)n;
            ...
            where TNode : DDLNode
        {
            ...
            {
                throw new InvalidOperationException(String.Concat("Catalog `", child.Name,
                    "` is obstructed another node: ",
                    n.Kind,
                    "."));
            }
            child.Ordinal = this._children.Count;
