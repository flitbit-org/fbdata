...
namespace FlitBit.Data
{
  ...
  {
    protected Action<IDbContext, TCacheKey, IEnumerable<KeyValuePair<TKey, TValue>>> CallbackOnContextEnd { get;
      private set; }
    ...
    public override object UntypedGet(object key) { return Get((TKey)key); }

    public override void UntypedPut(object key, object value) { Put((TKey)key, (TValue)value); }

    public override object UntypedRemove(object key) { return Remove((TKey)key); }
