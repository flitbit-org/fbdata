...
namespace FlitBit.Data.DataModel
{
        ...
        where TDbConnection : DbConnection
    {
        ...
        public override void PromoteCacheItem<T>(string key, T item, bool created)
        {
            ...
            if (mem != null
                && _mapping.CacheBehavior.HasFlag(ClusterCacheBehaviors.Cluster))
            {
                var buffer = item.CaptureBufferView();
                mem.Put(key, buffer);
                var chk = key.Split(':');
        ...
        public TDataModel ExecuteSingle<TParam, TParam1, TParam2, TParam3, TParam4, TParam5>(
            IDataModelQuerySingleCommand<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5>
                cmd,
            IDbContext cx,
        ...
        public TDataModel ExecuteSingle
            ...
            IDataModelQuerySingleCommand
                <TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7,
                    TParam8,
                    TParam9> cmd, IDbContext cx, TParam param, TParam1 param1, TParam2 param2, TParam3 param3,
            TParam4 param4,
        ...
        public IDataModelQueryResult<TDataModel> ExecuteMany<TParam, TParam1, TParam2, TParam3, TParam4, TParam5>(
            IDataModelQueryManyCommand<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5>
                cmd,
            IDbContext cx, QueryBehavior behavior,
            TParam param, TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5)
        {
