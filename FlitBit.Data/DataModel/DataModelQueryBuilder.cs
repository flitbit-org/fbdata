...
namespace FlitBit.Data.DataModel
{
        ...
        where TDbConnection : DbConnection
    {
            ...
            Expression<Func<TDataModel, TJoin, TParam, bool>> predicate)
        {
            ...
            return new DataModelJoinQueryBuilder<TDataModel, TIdentityKey, TDbConnection, TJoin, TParam>(repo, Writer,
                Key,
                sql);
        }
        ...
        /// <param name="predicate">a predicate expression</param>
        /// <returns></returns>
        public IDataModelQueryCommand<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5>
            Where<TParam, TParam1, TParam2, TParam3, TParam4, TParam5>(
        ...
        public
            IDataModelQueryCommand
                <TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7,
                    TParam8> Where<TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8>(
            Expression
