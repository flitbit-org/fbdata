...
namespace FlitBit.Data.DataModel
{
    ...
    IDataModelCommandBuilder<TDataModel, TDbConnection, TParam, TParam1>
  {
    ...
    /// <param name="queryKey">the query's key</param>
    /// <param name="sqlWriter">a writer</param>
    protected DataModelQueryCommandBuilder(IDataModelBinder<TDataModel> binder, string queryKey, DataModelSqlWriter<TDataModel> sqlWriter)
      : base(binder, queryKey, sqlWriter)
    {}
  ...
  public abstract class DataModelQueryCommandBuilder<TDataModel, TDbConnection, TParam, TParam1, TParam2> :
    DataModelCommandBuilder<TDataModel>,
    IDataModelCommandBuilder<TDataModel, TDbConnection, TParam, TParam1, TParam2>
  {
    ...
    /// <param name="constraints"></param>
    /// <returns></returns>
    protected abstract IDataModelQueryCommand<TDataModel, TDbConnection, TParam, TParam1, TParam2>
      ConstructCommandOnConstraints(
      Constraints constraints);
  }
  ...
  public abstract class DataModelQueryCommandBuilder<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3> :
    DataModelCommandBuilder<TDataModel>,
    IDataModelCommandBuilder<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3>
  {
    ...
    /// <param name="constraints"></param>
    /// <returns></returns>
    protected abstract IDataModelQueryCommand<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3>
      ConstructCommandOnConstraints(
      Constraints constraints);
  }
  ...
  public abstract class DataModelQueryCommandBuilder<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3,
                                                     TParam4> : DataModelCommandBuilder<TDataModel>,
                                                       IDataModelCommandBuilder
                                                         <TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3,
                                                           TParam4>
  {
    /// <summary>
    ///   Creates a new instance.
    ...
    /// <param name="constraints"></param>
    /// <returns></returns>
    protected abstract IDataModelQueryCommand<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4>
      ConstructCommandOnConstraints(
      Constraints constraints);
  }
  ...
  public abstract class DataModelQueryCommandBuilder<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3,
                                                     TParam4, TParam5> : DataModelCommandBuilder<TDataModel>,
                                                       IDataModelCommandBuilder
                                                         <TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3,
                                                           TParam4, TParam5>
  {
  ...
  public abstract class DataModelQueryCommandBuilder<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3,
                                                     TParam4, TParam5, TParam6> : DataModelCommandBuilder<TDataModel>,
                                                       IDataModelCommandBuilder
                                                         <TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3,
                                                           ...
                                                           TParam4, TParam5, TParam6, TParam7, TParam8, TParam9>
  {
    ...
    protected abstract
      IDataModelQueryCommand
        <TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8,
          TParam9> ConstructCommandOnConstraints(
      Constraints constraints);
  }
}