...
namespace FlitBit.Data.DataModel
{
    ...
    public interface IDataModelUpdateCommandBuilder<TDataModel, in TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4>
        where TDbConnection : DbConnection
    {
        /// <summary>
        /// Specifies constraints on the data model. The expression must evaluate like a predicate in order to be translated to SQL.
    ...
    public interface IDataModelUpdateCommandBuilder<TDataModel, in TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5>
        where TDbConnection : DbConnection
    {
        /// <summary>
        /// Specifies constraints on the data model. The expression must evaluate like a predicate in order to be translated to SQL.
    ...
    public interface IDataModelUpdateCommandBuilder<TDataModel, in TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>
        where TDbConnection : DbConnection
    {
        /// <summary>
        /// Specifies constraints on the data model. The expression must evaluate like a predicate in order to be translated to SQL.
        ...
        /// <param name="predicate">a predicate expression</param>
        /// <returns></returns>
        IDataModelNonQueryCommand<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6> Where(
    ...
    public interface IDataModelUpdateCommandBuilder<TDataModel, in TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7>
        where TDbConnection : DbConnection
    {
        /// <summary>
        /// Specifies constraints on the data model. The expression must evaluate like a predicate in order to be translated to SQL.
        ...
        /// <param name="predicate">a predicate expression</param>
        /// <returns></returns>
        IDataModelNonQueryCommand<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7> Where(
    ...
    public interface IDataModelUpdateCommandBuilder<TDataModel, in TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8>
        where TDbConnection : DbConnection
    {
        /// <summary>
        /// Specifies constraints on the data model. The expression must evaluate like a predicate in order to be translated to SQL.
        ...
        /// <param name="predicate">a predicate expression</param>
        /// <returns></returns>
        IDataModelNonQueryCommand<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8> Where(
    ...
    public interface IDataModelUpdateCommandBuilder<TDataModel, in TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9>
        where TDbConnection : DbConnection
    {
        /// <summary>
        /// Specifies constraints on the data model. The expression must evaluate like a predicate in order to be translated to SQL.
        ...
        /// <param name="predicate">a predicate expression</param>
        /// <returns></returns>
        IDataModelNonQueryCommand<TDataModel, TDbConnection, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9> Where(
