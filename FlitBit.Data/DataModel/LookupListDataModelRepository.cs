...
namespace FlitBit.Data.DataModel
{
  ...
  {
    static readonly string[] ClusterCacheObservations = new[]
    {
      "created",
      "updated",
      "deleted"
    ...
    class CachedItem
    {
      ...
      internal CachedItem(TDataModel value)
      {
        _item = value;
      }
    ...
    ConcurrentDictionary<TIdentityKey, CachedItem> _localCache = new ConcurrentDictionary<TIdentityKey, CachedItem>();
