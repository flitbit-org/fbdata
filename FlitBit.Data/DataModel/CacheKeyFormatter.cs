...
namespace FlitBit.Data.DataModel
{
  internal class CacheKeyFormatter
  {
    ...
    class KeyCapture<TDataModel, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6> : KeyCapture<TDataModel>
    {
      public override Delegate MakeFormatKey(IMapping<TDataModel> mapping, DataModelSqlExpression<TDataModel> sql)
      {
        var parms = sql.ValueParameters;
    ...
    class KeyCapture<TDataModel, TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9> :
      KeyCapture<TDataModel>
    {
      public override Delegate MakeFormatKey(IMapping<TDataModel> mapping, DataModelSqlExpression<TDataModel> sql)
      {
        ...
        return new Func<TParam, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, string>
          (
